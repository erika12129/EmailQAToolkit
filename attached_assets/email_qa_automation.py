...
def extract_email_metadata(soup):
    ...
    return {
        'sender': sender.get('content') or sender.get_text(strip=True) or 'Not found',
        'subject': subject.get('content') or subject.get_text(strip=True) or 'Not found',
        'preheader': preheader.get_text(strip=True) or 'Not found'
    }
